...
public final class Calculadora extends JFrame implements ActionListener {
    ...
    private void calculate(Operador operador, double b) {
        switch (operador) {
            case PLUS:
                operador1 += b;
                break;
